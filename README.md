...
Este módulo crea el documento de reporte y el documento de evidencias de las ejecuciones de los distintos test que se automatizan en TestCafe.
Registra las ejecuciones de los test en TestRail.
